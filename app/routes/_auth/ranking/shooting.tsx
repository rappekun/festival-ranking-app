...
export const loader = async () => {
	const data = await db
		.select()
		.from(results)
		.orderBy(desc(results.shooting_score))
		.limit(10);
	console.log("Ranking data:", data);
	return data;
};

const ShootingRanking: FC = () => {
	...
	return (
		<>
			...
			<main className="container mx-auto py-10">
				...
				<div className="rounded-2xl ring ring-blue-600 py-2 bg-gradient-to-r from-violet-100 to-green-200 shadow-lg">
...
export default ShootingRanking;
